...
export function CustomButton(props: { onClick: any; variant: any; children: any; width: any; height: any; fontSize: any; disabled?: false | undefined; loading?: false | undefined; style: any; }) {
  const { onClick, variant, children, width, height, fontSize, disabled = false, loading = false, style } = props;
  return (
    <Button
      variant={variant}
      onClick={onClick}
